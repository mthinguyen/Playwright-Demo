// Where we write all of the unit testing
...
test.describe('Head tag area', () => {
    test("Contains the head tag and its contents", async ({ page }) => {
        await page.goto(homePage); //locate the page first of all
...
test.describe('Main content', () => {
    test('Should contain a heading welcome ot my home page', async ({ page }) => {
